...
---@field FORCED_DISCONNECT_REASON_GENERIC number
---@field FORCED_DISCONNECT_REASON_PROTOCOLINCOMPATIBLE number
---@field FORCED_DISCONNECT_REASON_ROOMVERSIONMISMATCH number
...
---@field EVENT_DEFOLD_LOG_EVENT number
fusion = {}
---@param app_id string
---@param app_version string
---@param protocol string?
function fusion.init(app_id,app_version,protocol) end
...
---@param options table
---@param id string?
function fusion.create_map_object(map,owner_mode,options,id) end
...
---@param options table
---@return hash id
function fusion.spawn(factory_url,position,rotation,map,owner_mode,options) end
---@param id string?
...
---@param options table
---@param id string?
function fusion.create_object(factory_url,map,owner_mode,options,id) end
---@param id string?
function fusion.destroy_object(id) end
---@param data string
---@return number id
function fusion.map_add(data) end
---@param data string
---@return number id
function fusion.map_change(data) end
---@param map number
function fusion.map_remove(map) end
---@param map number
---@return boolean valid
function fusion.map_is_valid(map) end
---@param target_player number
---@param target_object hash
---@param event hash
---@param data table?
---@return boolean ok
function fusion.send_rpc(target_player,target_object,event,data) end
---@param rpc_event hash
---@param id hash?
function fusion.subscribe_rpc(rpc_event,id) end
---@param rpc_event hash
---@param id hash?
function fusion.unsubscribe_rpc(rpc_event,id) end
...
function fusion.respond_to_ownership_request(object,requester,granted) end
...
---@param id hash
function fusion.set_global_interest_key(id) end
---@param key hash
---@param id hash
function fusion.set_area_interest_key(key,id) end
---@param key hash
---@param id hash
function fusion.set_user_interest_key(key,id) end
---@param keys table
function fusion.set_area_keys(keys) end
---@param key hash
function fusion.add_user_key(key) end
---@param key hash
function fusion.remove_user_key(key) end
