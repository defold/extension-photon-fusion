...
namespace PhotonMatchmaking
{
	...
	public:
		...
		// Mutations
		bool SetOpen(bool open, const WebFlags& webFlags = {});
		bool SetVisible(bool visible, const WebFlags& webFlags = {});
		bool SetMaxPlayers(uint8_t maxPlayerCount, const WebFlags& webFlags = {});
	...
	private:
		...
		ExitGames::LoadBalancing::MutableRoom* LiveRoom() const;
